\documentclass[Master,UKenglish,Final]{scrbook}
%------------------------------------------------------------------------------
...
\newcommand*{\thesistown}{citizen of Meyrin (Geneva)}
...
%\input{include/planning}
\input{include/Introduction}
\input{include/CLIC}
\input{include/Silicon}
\input{include/Calibration}
\input{include/Software}
% \input{include/AllPix}
\input{include/Telescope}
\input{include/ThinSensors}
\input{include/ActiveEdgeSensors}
...
\include{include/appendix_Calibration}
\include{include/appendix_Telescope}
\include{include/appendix_ThinSensors}
\include{include/appendix_ActiveEdgeSensors}
...
\include{thesis_acknowledge}%nalipour acknowledge
