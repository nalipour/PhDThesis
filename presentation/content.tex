...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/residual_1hit_W19_G7.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]

        \node[color=black] at (0.33, 0.6) {\textcolor{Green}{1-pixel}};
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/residual_2hit_W19_G7.pdf}};
        \begin{scope}[x={(image.south east)},y={(image.north west)}]

          \node[color=black] at (0.33, 0.6) {\textcolor{Green}{2-pixel}};
          % \node[color=black] at (0.35, 0.7) {Multi-pixel};
...
%    \item 28-GNDGR-50
  ...
  \textcolor{RedViolet}{\textbf{$\rightarrow$http://dx.doi.org/10.1016/j.nima.2016.05.133}}
