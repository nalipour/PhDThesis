...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      ...
      \node[text width=2.5cm, color=black] at (0.95, 0.58)
      ...
      \node[text width=3cm, color=black] at (1.05, 0.2) {Forward
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
  ...
  \begin{frame}
    ...
    \begin{itemize}
    \item Hybrid pixel detector: \textcolor{Green}{sensor} \&
...
\begin{frame}
  ...
  \item \textsc{Geant4} simulation:
    ...
    \item Agreement in width and most-probable-value (MPV) of the distributions \ding{51}
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/150micron_resX.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
