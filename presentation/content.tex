...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      ...
      0){\includegraphics[width=\textwidth]{figures/hadronColliders.pdf}};
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,
      0){\includegraphics[width=\textwidth]{figures/leptonColliders.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{frame}
  ...
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,
    0){\includegraphics[width=0.8\textwidth]{figures/CLIC_detector_2016.jpg}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      ...
      \node[text width=3cm, color=black] at (1.1, 0.5)
      {Silicon-based vertex detector \& tracking system};
      \draw[->,line width=0.7pt] (0.92, 0.55) -- (0.5, 0.6);
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,
      0){\includegraphics[width=\textwidth]{figures/CLIC_detector_2016_zoomVertex}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at (0,
      0){\includegraphics[width=\textwidth]{figures/spiralVXD_2.png}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
        \draw[<->, Blue, thick](0.2, 0.0)--(0.84, 0.2);
        \node[below, color=Blue] at (0.5, 0.05) {56 cm};
      \end{scope}
...
\begin{frame}
  ...
  \beamerbutton{Optimisation Studies for the CLIC Vertex-Detector Geometry, CLICdp-Note-2014-002.}
...
% ----------------------------- %
\begin{frame}
  \frametitle{R\&D for planar pixel sensors at CLIC}
  ...
  \begin{tikzpicture}
    ...
    (0,0){\includegraphics[width=\textwidth]{figures/Advacam-50um-assembly.jpeg}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      \node[above, color=Black] at (0.2, 0.8) {\small{$50\,\micron$
          sensor}};
      \node[above, color=Black] at (0.2, 0.7) {\small{$700\,\micron$ Timepix}};
    \end{scope}
  \end{tikzpicture} 
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/ActiveEdge/Allpix_telescope_withParticles.png}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{frame}
  ...
  %   sharing.
  \item Cluster: the group of pixels showing a signal from the same
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/TrackPosWPixel_1hit_runW19_G7.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]

        \draw[<->, very thick, color=Blue](0.18, 0) -- (0.82, 0);
        \node[below, color=Blue] at (0.5, 0.0) {pitch};
        \node[below, rotate=90] at (0.92, 0.7) {\tiny{Entries}};
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/TrackPosWPixel_2hit_runW19_G7.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
        \node[below, rotate=90] at (0.92, 0.7) {\tiny{Entries}};
      \end{scope}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/TrackPosWPixel_3hit_runW19_G7.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
        \node[below, rotate=90] at (0.92, 0.7) {\tiny{Entries}};
      \end{scope}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/TrackPosWPixel_4hit_runW19_G7.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
        \node[below, rotate=90] at (0.92, 0.7) {\tiny{Entries}};
      \end{scope}
    \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/TestBeam/50micron_resX.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]

        \node[color=black] at (0.55, 0.3) {Single-pixel};
        \node[color=black] at (0.35, 0.7) {Multi-pixel};
  ...
  \begin{columns}
    \column{0.5\textwidth}
    \begin{itemize}
    \item Simulation in agreement with data
    \end{itemize}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \item High detection efficiency (as a function of the readout ASIC
      threshold):
      \begin{itemize}
      \item For thinner sensors, the energy deposition is lower
...
%    \item 28-GNDGR-50
  ...
  \end{itemize}
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=0.8\textwidth]{figures/20_edge_GRND_GR_2.png}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=0.8\textwidth]{{figures/50_edge_GRND_GR_2.png}}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
  ...
  \beamerbutton{Recent results with HV-CMOS and planar sensors for the
    CLIC vertex detector, http://dx.doi.org/10.1016/j.nima.2016.05.133}
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=\textwidth]{../figures/ActiveEdge/TCAD_transient_23FGR_hitpos_60.png}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
...
\begin{frame}
 ...
 \begin{columns}
  ...
  \begin{columns}
    ...
    \column{0.5\textwidth}
    \centering 
    \reflectbox{\includegraphics[width=0.5\textwidth]{../figures/ActiveEdge/streamlines_20-NGR-50.png}}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{itemize}
    \item $50\,\micron$-thick sensor
    \item Grounded Guard ring
    \item Edge-to-pixel distance: $28\,\micron$
    \end{itemize}
    ...
    \column{0.5\textwidth}
    \centering
    \reflectbox{\includegraphics[width=0.5\textwidth]{../figures/ActiveEdge/streamlines_28-GNDGR-50.png}}
...
\begin{columns}
  ...
  \begin{columns}
    ...
    \item $50\,\micron$-thick sensor
    \item Grounded Guard ring
    \item Edge-to-pixel distance: $55\,\micron$
    \end{itemize}

    \column{0.5\textwidth}
    \centering
    \reflectbox{\includegraphics[width=0.5\textwidth]{../figures/ActiveEdge/streamlines_55-GNDGR-50.png}}
...
%  \frametitle{Active-edge sensor with floating GR (23-FGR-50)}
 ...
 \begin{columns}[t]
  ...
  \begin{columns}
    ...
    \begin{itemize}
    \item $50\,\micron$-thick sensor
    \item Floating Guard ring
    \item Edge-to-pixel distance: $23\,\micron$
    \end{itemize}
    ...
    \centering
    \reflectbox{\includegraphics[width=0.5\textwidth]{../figures/ActiveEdge/streamlines_23-FGR-50.png}}
  \end{columns}
  ...
  \item Characterisation of thin and active-edge planar silicon pixel
    sensors
      ...
      \item Thin sensors:
        ...
        \item Implementation of Timepix3 \textsc{Geant4}-based simulations with
          data $\Rightarrow$ good agreement with data
        \end{itemize}
...
\begin{frame}
  ...
  \begin{columns}[t]
    ...
    \begin{tikzpicture}
      \node[anchor=south west,inner sep=0] (image) at
      (0,0){\includegraphics[width=0.8\textwidth]{../figures/TestBeam/150micron_resX.pdf}};
      \begin{scope}[x={(image.south east)},y={(image.north west)}]
