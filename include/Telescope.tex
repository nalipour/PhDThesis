...
described in \cref{tab:TPX3TelescopeMaterial}. The PCB stacks up eight
layers of copper interlacing with Isola IS410 type material. In
\textsc{Geant4} simulations, G4\_BONE\_COMPACT\_ICRU is used for the
simulation of Isola IS410.

\begin{table}[htbp]
  \centering
  \caption{The mechanical support material used for the \textsc{Geant4} simulation of the telescope planes with X the thickness in millimeters, X\textsubscript{0} the radiation length in millimeters.}
