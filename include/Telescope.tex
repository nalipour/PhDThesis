...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
      ...
      \node[above, color=black] at (0.9, 0.05) {Plane 0};
      \node[above, color=black] at (0.75, 0.05) {Plane 1};
      \node[above, color=black] at (0.6, 0.05) {Plane 2};
      \node[above, color=black] at (0.48, 0.05) {DUT};
      \node[above, color=black] at (0.35, 0.05) {Plane 3};
      \node[above, color=black] at (0.2, 0.05) {Plane 4};
      \node[above, color=black] at (0.07, 0.05) {Plane 5};
