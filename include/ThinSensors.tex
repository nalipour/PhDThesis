...
The Timepix3 readout chip is used as a test vehicle for the
characterisation of thin sensors. The test-beam measurements and the
AllPix simulations show a good agreement. Although, the Timepix3
readout chip has a pixel pitch of $55\,\micron$ and the goal for the
CLIC vertex detector is to have pixels of pitch $25\,\micron$.
