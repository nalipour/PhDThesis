...
summarised in \cref{fig:depletionVoltage}.
...
residual measurements presented. For the estimation of the single-point
resolution, the tracking resolution of $\sim2\,\micron$ at the SPS
test beam should be unfolded.
...
comparing data and simulations. The simulation is in good agreement
with the data.
...
resulting resolution of $\sim$$6\,\micron$ is still significantly
worse than the required $3\,\micron$.
