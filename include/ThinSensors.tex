...
\begin{figure}[htbp]\centering
  ...
  \caption{(a) Cluster-size distribution and (b) hit residuals,
    comparing the hit and the MC truth position, in x-direction for
    the extrapolation of the simulation to small pixel sizes with a
    $50\,\micron$ thick sensor and a threshold of $\sim~500$
    electrons.}
