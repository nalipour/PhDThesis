...
%% --------------------------------------------- %%
\newpage
\subsection{Advacam process flow for active edge sensors}
\label{sec:AdvacamProcessFlow}

The process flow used by Advacam is schematically illustrated in
...
%% --------------------------------------------- %%
\newpage
\subsection{Layout parameters of active-edge assemblies}
...
%% --------------------------------------------- %%
\newpage
\subsection{Simulation process flow for the active-edge designs}
