...
The performance of the edge is compared in data and simulation in
terms of efficiency and collected charge in the edge as a function of
the track position. The convention as illustrated in
\cref{fig:Layout20_NGR} is used to show the performance of the
