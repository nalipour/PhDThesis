...
The analogue-to-digital converter (ADC) converts a continuously
varying amplitude to discrete steps. When the pulse height passes the
threshold in the discriminator, counters are incremented to measure
the energy and the timing of the signal.
...
measured. For the Timepix3 readout chip a capacitance of
$20.2$~e\textsuperscript{-}/mV is a good approximation.
