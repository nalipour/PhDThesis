...
threshold. \cref{tab:numberOfMaskedPixels} shows the number of pixels
masked for the tested assemblies. They were masked either after the
...
\begin{table}[htbp]
  \centering
  \caption{The number of masked pixel after the equalisation and the
