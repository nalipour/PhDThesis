...
is then provided to the main beam. The average length of an
accelerating structure is 878~m long and accelerates the main beam by
$\approx62\,\gev$.
...
design constraints for the vertex detector. Therefore, the detector
...
geometries have been studied for CLIC. This section presents the
impact of the geometry on the flavour-tagging performance in
simulations.
