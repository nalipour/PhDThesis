...
\ll N_c$). $N_c$ and $N_b$ are used for a more generalisation of the
doping regions and they can consist of both donors or acceptors. The
doping concentration is expressed in terms of the bulk resistivity
$\rho_b$:
\begin{equation}
...
The drift time depends on the charge carriers as shown in
...
$z$=depth. The electrons have a higher drift time and therefore are
faster for readout. Diffusion does not depend on the carrier type
