...
In literature, several approaches address the calculation of the straggling functions. Two of the most relevant ones are described in \cref{sec:landau} and \cref{sec:bichsel}.
