...
\begin{figure}[htbp] \centering
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/50um_bichsel_physicsLists.pdf}
    \caption{}
  \end{subfigure} \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/450um_bichsel_physicsLists.pdf}
    \caption{}
  \end{subfigure}
...
sensor with a depletion voltage of 4~V and biased at 15~V as a
function of the depth. The electrons have a higher drift time and
therefore are faster for readout. But the diffusion does not depend on
the carrier or the bulk type.
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/DriftTime_n_vs_p_carrier.pdf}
  \caption{Drift time for n and p-type carriers as a function of the
    depth in the sensor. The depletion voltage is 4~V and the bias
    voltage is 15~V.}\label{fig:Drift_n_vs_p}
\end{figure}
...
\cref{fig:SpatResBinary}. The average difference between the real
position ($x_r$) and the measured position ($x_m=0$) of the particle
in a pixel is calculated using \cref{eq:spatialRes}
\cite{Rossi:976471}:
\begin{equation}
