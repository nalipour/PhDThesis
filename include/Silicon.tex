...
\subsubsection{Analogue readout and charge sharing}\label{sec:resolutionAnalogSharing}
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{scope}
  \end{tikzpicture}
  \caption{Analogue readout with charge sharing}\label{fig:SpatResAnaglogChargeSharing}
\end{figure}
