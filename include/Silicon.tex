...
% shown in \cref{fig:RamoTCADCuts}. The total charge collected by the
% electrode $k$ depends only on the depth positions $z_0$ and $z_p$. In
% the absence of the radiation-induced damages (which would affect the
% distributions of the electric and weighting fields), the weighting
% field does not affect the total charge collected by an electrode and
% does not contribute to the diffusion of the charges. The charge
% carriers drift following the electric field distribution and due to
% the diffusion several electrodes can collect charges.
...
%   \end{subfigure} 
%   \caption{The weighting potential for different positions on the
%     x-axis using TCAD simulations. The detector has a thickness of
%     $200\,\micron$.}
