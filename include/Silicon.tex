...
The interaction of incident radiation with silicon sensor is the basis
...
\begin{table}[htbp]
  \centering
  \caption{Summary of the variables used in the Bethe-Bloch formula. From~\cite{Beringer:1900zz}.}
  \label{tab:BetheVars}
  \resizebox{\textwidth}{!}{\begin{tabular}{l l l}
                              \toprule
                              Symbol & Definition & Units or value \\
                              \midrule
                              $N_A$ & Avogadro's number & $6.022 1415(10) \times
                                                          10^{23}\,\text{mol}^{-1}$ \\
                              $r_e$ & Classical electron radius & 2.817 940 325(28) fm \\
                              $m_ec^2$ & Electron mass$\times c^2$ &  0.510 998 918(44) \mev\\
                              $z$ & Charge of the traversing particle & Units of the electron
                                                                        charge\\
                              $Z$ & Atomic number of the medium & -\\
                              $A$ & Atomic mass of the medium & -\\
                              $T_{max}$ & Maximum kinetic energy that a particle can
                                          transfer to a shell electron & -\\
                              $\delta\left(\beta\gamma\right)$ & Density effect correction to
...
The energy loss probability in a detector with a moderate thickness
...
\begin{figure}[htbp]
  ...
  \caption{Schematic layout of a hybrid pixel detector. A pixellated
    ...
    From~\cite{Spieler2005}.}%\cite{Rossi:976471}.}
  \label{fig:pixelCell}
  % \end{wrapfigure}
\end{figure}
